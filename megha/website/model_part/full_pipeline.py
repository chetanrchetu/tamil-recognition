...
model=tf.keras.models.load_model(r'D:\major_project\megha\website\model_part\model_trained\Image_model.keras')
model.compiled_metrics == None
CATEGORIES=pd.read_csv(r'D:\major_project\megha\website\model_part\Category.csv')
...
def perform_segemenation(image_path):
    ...
    for cnt in contours_with_positions:
        ...
        cv2.imwrite(f"website\\model_part\\segemented_images\\{i}.png",roi)
...
def translate_tamil(tamil_word):
    chromedriver_path=r'D:\major_project\megha\website\model_part\chromedriver.exe'
...
def predict_(path):
    ...
    string_to_send=prediction_part(r'D:\major_project\megha\website\model_part\segemented_images')
...
if __name__=='__main__':
    y_pred,y=predict_(r'D:\major_project\megha\website\static\temp_images\image.png')

    os.remove(r'D:\major_project\megha\website\static\temp_images\image.png')
